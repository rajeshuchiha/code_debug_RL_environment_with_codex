...
TEST_CASES = [{'input': [2, 4, 6], 'expected': {'total': 12, 'average': 4.0, 'min': 2, 'max': 6}}, {'input': [5], 'expected': {'total': 5, 'average': 5.0, 'min': 5, 'max': 5}}, {'input': [], 'expected': {'total': 0, 'average': 0, 'min': None, 'max': None}}]
